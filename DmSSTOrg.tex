...
\usepackage[paperwidth=22.5cm,paperheight=19.5cm,
...
\begin{tikzpicture}[node distance=0mm]
    ...
    \node (dm) [arcbox, align=right, text width=15.5cm,  minimum height=10mm, rectangle split, rectangle split parts=2]
    { \hspace{0.1cm} \textbf{Data Management Subsystem Science Team (DM-SST)}
	   \nodepart{second} \vspace{110mm}
	};

    \node (dmpsanc) [above=-1.8 of dm.north]{};
    \node (dmps) [psbox, left=1.55cm of dmpsanc, minimum height=12mm, text width=47mm] {\textbf{ DM Subsystem Scientist}\\ Leanne Guy };
    \node (ddmps) [psbox, right=3.5cm of dmps, minimum height=12mm, text width=52mm] {\textbf{ Deputy DM Subsystem Scientist}\\ Colin Slater };
    \node (ps) [psbox, above=1.8cm of dmps, minimum height=12mm] {\textbf{  Project Scientist}\\ Steve Ritz};
    \node (dmpm) [divbox, left=1.8cm of dmps] {\textbf{ DM Project Manager} William O'Mullane};
...
% Pipelines scientist
    \node (pipesci) [psbox, below =3mm of ddmps, text width=52mm, minimum height=12mm] {\textbf{DM Science Pipelines Scientist}\\ Jim Bosch};

% Calibration scientist
    \node (calsci) [psbox, below =3mm of pipesci, text width=52mm, minimum height=12mm] {\textbf{DM Calibration Scientist}\\ Eli Rykoff};
    
% Verification Scientist
    \node (valsci) [psbox, below=3mm of calsci, text width=52mm, minimum height=12mm] {\textbf{DM Science Validation Scientist}\\  Jeff Carlin};

% Product Owners
            \node (instleads) [mbox, text width=65mm, rectangle split, rectangle split parts=2,  below=15mm of dmps]
                {
                Institutional Science Leads
                \nodepart{second} \vspace{70mm}
                };
    ...
    \node (suitsc) [psbox, below=1mm of drpsc, text width=55mm] {\textbf{Science Platform Scientist}\\ Gregory Dubois-Felsmann};
    \node (mwsc) [psbox, below=1mm of suitsc, text width=55mm] {\textbf{Middleware Scientist}\\ Jim Bosch};
    \node (daxsc) [psbox, below=1mm of mwsc, text width=55mm] {\textbf{Data Access Services Scientist}\\ Colin Slater};
    \node (sqsc) [psbox, below=1mm of daxsc, text width=55mm] {\textbf{SQuaRE Scientist}\\ Simon Krughoff};
