...
\usepackage[paperwidth=19.5cm,paperheight=13.0cm,
left=0mm,top=3mm,bottom=0mm,right=0mm,
...
% Verification Scientist
    \node (valsci) [psbox, below=3mm of pipesci, text width=52mm, minimum height=12mm] {\textbf{DM Science Validation Scientist}\\  Jeff Carlin};
...
% InstLeads
    ...
    \node (dpsc) [psbox, below=1mm of suitsc, text width=55mm] {\textbf{DP / Middleware Scientist}\\ Robert Gruendl};
