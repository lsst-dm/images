...
\usepackage[paperwidth=30cm,paperheight=15cm,
...
%%%
    ...
    \node (crd) [docboxm, text width=38mm,  right=20mm of pmp.east] {Config/Release/Deploy Management };
...
%reports
 ...
 %icds 
   \draw[dline] (scireq.west) -- (daicd.east);
   \draw[dline] (scireq.west)  -- ++(-10,0)  -| ++(0,1.5) --  (camicd.east);
   \draw[dline] (scireq.west)  -- ++(-10,0)  -| ++(0,2.9) -- (csicd.east);
   \draw[dline] (scireq.west) -- ++(-10,0)  -| ++(0,4.3) -- (sumicd.east);
   \draw[dline] (scireq.west) -- ++(-10,0)  -| ++(0,5.8) -- (baseicd.east);
   \draw[dline] (scireq.west) -- ++(-10,0)  -| ++(0,7.2) -- (epoicd.east);
   \draw[dline] (scireq.west) -- ++(-10,0)  -| ++(0,8.7) -- (auxicd.east);
