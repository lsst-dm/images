...
%%%%%% REQUIREMENTS %%%%%
    ...
    \node (l2t) [docboxu, right=7mm of l1t] { L2 Test Spec  LDM-534};
  ...
  %%%%%%%%%% test reports %%%%%%%%%%%%%%%%%%%
    ...
    \node (dbbtr) [docboxu, above=25mm of dbbt] { DBB Test Reports };
    ...
    \node (l2tr) [docboxu, above=25mm of l2t] { L2 Test Reports };
    \node (infratr) [docboxu, above=25mm of infrat] { Infrastructure Test Reports };
