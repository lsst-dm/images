...
%  LEGEND
	...
	\node (date) [right= 12cm of ttext] {\today};
...
%%%
    ...
    \node (pmp) [docbox, right=85mm of dpdd.east] { DM PMP LDM-294};
...
%%%%%% REQUIREMENTS %%%%%
    \node (scipr) [docbox, left=84mm of compd] { Science Platform Requirements LDM-554};
    \node (sciapr) [docbox, right=5mm of scipr] { L1 (prompt)  Requirements LDM-602};
   ...
   % \node (suitc) [docboxu, above=5mm of scipc] { SUIT Design LDM-131};
    ...
    \node (scipt) [docbox, right=7mm of datast] {Science Platform  Test Spec LDM-540 };
