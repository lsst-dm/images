...
%%%
    ...
    \node (mwc)  [docboxu, left=5mm of plc] { Middleware Design LDM-152};
    ...
    \node (suitc) [docboxu, right=5mm of infrac.east] { SUIT Design LDM-131};
    \node (netc) [docbox, right=5mm of suitc.east] { Network Design LSE-78};
    \node (userd)  [docbox, right=45mm of compd] { User Documentation };

    \node (ncsaenct) [docboxm, above=12mm of auxicd ] { NCSA Enclave Test Spec LDM-532};
    ...
    \node (l2tr) [docboxm, above=5mm of l2t] { L2 Test Reports };
    \node (ncsaenctr) [docboxm, above=5mm of ncsaenct] { NCSA Enclave Test Reports };
    \node (baseenctr) [docboxm, above=5mm of baseenct] { Base Enclave Test Reports };
    \node (ccenctr) [docboxm, above=5mm of ccenct] {Comm Cluster Test Reports };
    
    \node (dbbtr) [docboxm, above=5mm of dbbt] { DBB Test Reports };
    \node (datastr) [docboxm, above=5mm of datast] { Data Services Test Reports };
    \node (sciptr) [docboxm, above=5mm of scipt] { Science Platform Test Reports };
    \node (l1tr) [docboxm, above=5mm of l1t] { L1 Test Reports };
    \node (l2tr) [docboxm, above=5mm of l2t] { L2 Test Reports };
    \node (infratr) [docboxm, above=5mm of infrat] { Infrastructure Test Reports };
