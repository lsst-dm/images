...
\begin{tikzpicture}[node distance=0mm]
    ...
    \node (dmadv) [psbox, left=1.5cm of dmpm ] {\textbf{Senior Advisor}\\ Robert Lupton};
    \node (dmdpm) [divbox, below=0.5cm of dmadv] {\textbf{DM Deputy Manager} John Swinbank};
...
% SYSENG
    ...
    \node (ops) [psbox, below=1mm of dmsci, text width=39mm] {\textbf{ Operations  Architect}\\ Michelle Butler };
    ...
    %\node (reqeng) [pobox, below=1mm of softarc, text width=39mm] {\textbf{Sci Platform Scientist/ Interface Scientist}\\ Gregory Dubois-Felsmann  };
%%%% end SYSENG
    ...
    \dmnode[left=1mm of udmpm2.north]{sciplat}{Science Platform}{Frossie Economou}{Gregory Dubois-Felsmann}{psbox} ;
    \dmnode[base left=2mm of sciplat]{das}{Data Access Services}{Fritz Mueller}{Leanne Guy} {psbox};
 ...
 %% GROUPS ..
    ...
    \node (dmsg) [psbox, above=1.0cm of pcon, minimum height=12mm] {\textbf{DM Subsystem Science Team}};
   ...
   \draw[line] (dmdpm.east) -|  (dmpm.south);
   \draw[sline] (dmadv.east) --  (dmpm.west);
