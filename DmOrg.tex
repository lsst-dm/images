...
% SYSENG
    ...
    \node (dmsci) [psbox, below=1mm of dman, text width=39mm] {\textbf{DM Subsystem Scientist}\\ {\color{red} Open}};
    ...
    \node (reqeng) [pobox, below=1mm of syseng, text width=39mm] {\textbf{Sci Platform Scientist/ Interface Scientist}\\ Gregory Dubois-Felsmann  };
%%%% end SYSENG

    \node (cm) [mbox, right=3.1cm of udmpm1.north , text width=45mm] {\textbf{Configuration/Release Manager }\\ Gabriele Comoretto};
    ...
    \dmnode[base left=2mm of suit]{das}{Data Access Services}{Fritz Mueller}{DM Subsystem Scientist} {psbox};
 ...
 %% GROUPS ..
    ...
    \node (dmsg) [psbox, right=0.9cm of dmps, minimum height=12mm] {\textbf{DM Subsystem Science Team}};
