...
%%%% end SYSENG
    ...
    \node (admin) [mbox, below=5mm of pcon, text width=45mm] {\textbf{DM Admin}\\ Michelle Poland};
    ...
    \node (drp) [mbox, text width=36mm, rectangle split, rectangle split parts=2, base left=2mm of das]
	 ...
	 \dmnode[base right=2mm of infra]{lhn}{LHN \& Base Site}{Cristian Silva}{Michelle Butler}{pobox} ;
