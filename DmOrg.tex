...
\begin{tikzpicture}[node distance=0mm]
    ...
    \node (udmpm) [below=37mm of dmpm, text width=0mm]{};
    \node (udmpm1) [below=8mm of dmpm, text width=0mm]{};
% SYSTEM EN4G
            \node (sysengg) [mbox, text width=50mm, rectangle split, rectangle split parts=2, left=4.1cm of udmpm.north]
                {
                Systems Engineering
...
%%%% end SYSENG
    ...
    \node (docu) [mbox, below=5mm of pcon, text width=45mm] {\textbf{4M Documentalist}\\ Jonathon Sick };
    ...
    \dmnode[below=85mm of dmpm]{suit}{SUIT} {Xiuqin Wu  }{ David Ciardi } ;
    ...
    \node (drp) [mbox, text width=36mm, rectangle split, rectangle split parts=2, base left=2mm of das]
         {
	  Data Release/Alert Production
	  \nodepart{second} \vspace{30mm}
	 };
    
         \node(drpt) [mbox,minimum height=6mm, below=11mm of {drp}.north, text width=32mm] {\parbox[height=6mm]{0pt}{}{\small \bf TCAM}\\John Swinbank };
          \node(drps) [psbox,minimum height=8mm, below=2pt of drpt, text width=32mm] {{\small \bf DRP Owner}\\ Jim Bosch};
          \node(alerts) [psbox,minimum height=8mm, below=2pt of drps, text width=32mm] {{\small \bf Alerts Owner}\\
Eric Bellm};
