...
% SYSENG
            \node (sysengg) [mbox, text width=50mm, rectangle split, rectangle split parts=2, left=3.1cm of ccbVpos.north]
                {
                 Core DMCCB
                \nodepart{second} \vspace{55mm}
                };
    \node (chair) [mbox, below=6mm of sysengg.north, text width=39mm] {\textbf{ System Engineer (Chair) }\\ Tim Jenness };
    \node (dmsci) [psbox, below=1mm of chair, text width=39mm] {\textbf{DM Scientist}\\ Leanne Guy};
...
%%%% end SYSENG
    ...
    \node (admin) [mbox, below=5mm of pcon, text width=45mm] {\textbf{DM Admin}\\ Aime  Wiest\\ Erin Carlson};
