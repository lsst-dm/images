...
%%%% end SYSENG
    ...
    \node (drp) [mbox, text width=36mm, rectangle split, rectangle split parts=2, left=2mm of das]
         {
...
Eric Bellm};
    ...
    \dmnode[right=2mm of suit]{square}{SQuaRE} {Frossie Economou}{ Simon Krughof} ;
