...
\begin{tikzpicture}[node distance=0mm]
    ...
    \node (dmps) [psbox, right=1.3cm of dmpm, minimum height=12mm, text width=39mm] {\textbf{ DM Subsystem Scientist}\\ Leanne Guy };
    \node (ddmps) [psbox, right=0.4cm of dmps, minimum height=12mm, text width=41mm] {\textbf{ Deputy DM Subsystem Scientist}\\ Colin Slater };
    \node (ps) [psbox, right=1.5cm of pm, minimum height=12mm] {\textbf{  Project Scientist}\\ \v{Z}eljko Ivezi\'c};
...
% SYSENG
    ...
    \node (dmsci) [psbox, below=1mm of dman, text width=39mm] {\textbf{DM Subsystem Scientist}\\ Leanne Guy};
    \node (pipe) [psbox, below=1mm of dmsci, text width=39mm] {\textbf{ Pipelines Scientist}\\ Robert Lupton };
    ...
    \node (reqeng) [psbox, below=1mm of softarc, text width=39mm] {\textbf{Platform \& Interfaces }\\ Gregory Dubois-Felsmann  };
%%%% end SYSENG
    ...
    \node (admin) [divbox, minimum height=0mm, below=5mm of pcon, text width=45mm] {\textbf{DM Admin}\\ Libby Petrick};
    ...
    \node (infra) [mbox, text width=36mm, rectangle split, rectangle split parts=2, base right=2mm of square]
         ...
         \node(infrapo) [psbox,minimum height=9mm, below=2pt of dft, text width=32mm] {{\small \bf Infrastructure Owner}\\\strut Michelle Butler};
	 ...
	 \dmnode[base right=2mm of infra]{lhn}{LHN \& Base Site}{Jeff Kantor}{Michelle Butler}{psbox} ;
...
\node (leg) [lbox, below=3cm of admin, text width=35mm,  minimum height=10mm, rectangle split, rectangle split parts=2]
    { \hspace{0.1cm} \textbf{Legend}
           \nodepart{second} \vspace{39mm}
        };
 \node(snode) [psbox,below=0.7cm of leg.north, text width=30mm] {Science or Product Owner Role};
 \node(pnode) [mbox,minimum height=12mm, below=0.1cm of snode, text width=30mm] {Technical Role};
 \node(mnode) [divbox,below=0.1cm of pnode, text width=30mm] {Managment or
 Admin Role};
