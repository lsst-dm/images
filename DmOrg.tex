...
% Team with T/CAM and a Product Owner
\newcommand\dmnode[6][]{
...
%%%% end SYSENG
    ...
    \dmnode[left=12mm of udmpm2.north]{das}{Data Access Services}{Fritz Mueller}{Colin Slater} {psbox};
    ...
    \node (drp) [mbox, text width=36mm, rectangle split, rectangle split parts=2, base left=2mm of das]
	 ...
	 \dmnode[base right=2mm of square]{infra}{Data Facility }{Michelle Butler \\{\bf Deputy}\\ Margaret Johnson}{Robert Gruendl}{psbox} ;
