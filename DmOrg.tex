...
\begin{tikzpicture}[node distance=0mm]
    ...
    \node (dmps) [psbox, right=1.5cm of dmpm, minimum height=12mm] {\textbf{ DM Project Scientist}\\ Mario Juri\'c};
...
%%%% end SYSENG
    ...
    \dmnode[base right=2mm of square,text width=40mm]{infra}{Infrastructure \& Processing} { Margaret Gelman }{ Robert Gruendl, Don Petravick} ;
