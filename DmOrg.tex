...
\begin{tikzpicture}[node distance=0mm]
    ...
    \node (dmps) [psbox, right=1.3cm of dmpm, minimum height=12mm, text width=39mm] {\textbf{ Subsystem Scientist}\\ Leanne Guy };
    \node (ddmps) [psbox, right=0.4cm of dmps, minimum height=12mm, text width=41mm] {\textbf{ Deputy Subsystem Scientist}\\ Colin Slater };
...
% SYSENG
    ...
    \node (dmsci) [psbox, below=1mm of dman, text width=39mm] {\textbf{Subsystem Scientist}\\ Leanne Guy};
