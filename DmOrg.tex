...
% SYSENG
            \node (sysengg) [mbox, text width=55mm, rectangle split, rectangle split parts=2, left=3.1cm of ccbVpos.north]
                {
                 Core DMCCB
                \nodepart{second} \vspace{53mm}
                };
    \node (chair) [mbox, below=6mm of sysengg.north, text width=42mm] {\textbf{ Software Architect \\(Chair) }\\ Tim Jenness };
...
%%%% end SYSENG
    ...
    \node (admin) [mbox, below=8mm of pcon, text width=45mm] {\textbf{DM Admin}\\ Lubianca Rasmussen \\ Erin Carlson};
    ...
    \node (drp) [mbox, text width=36mm, rectangle split, rectangle split parts=2, base left=2mm of das]
	 ...
	 \dmnode[base right=2mm of das]{square}{SQuaRE} {\strut Frossie Economou}{  }{psbox} ;


	 \dmnode[base right=2mm of square]{infra}{Data Facility }{Steven Pietrowicz}{Leanne Guy}{psbox} ;
	 \dmnode[base right=2mm of infra]{lhn}{IT, LHN, Base Site}{Cristi\'an Silva}{Steven Pietrowicz}{pobox} ;
