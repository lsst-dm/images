...
\begin{tikzpicture}[node distance=0mm]
    ...
    \node (fdfa) [psbox, left=2cm of dpad, text width=4cm] {\textbf{Advisor \\French Data Facility}\\ Fabio Hernandez};
    \node (udfa) [psbox, below=0.5cm of fdfa, text width=4cm] {\textbf{Advisor \\US Data Facility}\\ Richard Dubois };
...
%
	...
	\node(sumw)[arcbox,below=4cm of dpad]{\textbf{ Science Users Middleware} \\Tim Jenness} ;
...
\draw[sline] (fdfa.east) to (dpad.west);
	\draw[sline] (udfa.east) -- ++(0.1,0) -|  (dpad.west);
